...
if (!function_exists('bootstrapBasicEnqueueScripts')) {
    ...
    function bootstrapBasicEnqueueScripts() 
    {
        ...
        wp_enqueue_style('bootstrap-theme-style', get_template_directory_uri() . '/assets/css/bootstrap-theme.min.css', array(), '3.4.1');
        wp_enqueue_style('fontawesome-style', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), '4.7.0');
        wp_enqueue_style('main-style', get_template_directory_uri() . '/assets/css/main.css', array(), $themeVersion);
        ...
        if (bootstrapBasicHasWidgetBlock('calendar') === true) {
            ...
            wp_enqueue_style('bootstrapbasic-widgetblocks-calendar', get_template_directory_uri() . '/assets/css/widget-blocks/calendar.css', array(), $themeVersion);
        }

        // js that is useful for development.
        wp_enqueue_script('modernizr-script', get_template_directory_uri() . '/assets/js/vendor/modernizr.min.js', array(), '3.6.0-20190314', true);
        ...
        wp_enqueue_script('main-script', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), $themeVersion, true);
